...
class FringeHeur(Fringe):
    """
    This is an extension of the fringe class for impementing astar
    """

    def __init__(self, problem, heuristic, strategy ='astar'):
        self.fringe = util.PriorityQueueWithFunction(self.priorityFn) # creates the function but only run the function at runtime.
